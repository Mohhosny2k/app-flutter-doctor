...
class BoneScreen extends StatefulWidget {
  const BoneScreen({super.key});

  @override
  State<BoneScreen> createState() => _BoneScreenState();
}
...
class _BoneScreenState extends State<BoneScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      builder: (context, state) {
        if (state is GetBoneLoadingState) {
          return Center(
            child: CircularProgressIndicator(),
          );
        } else if (state is GetBoneErrorState) {
          return Center(
                ...
                body: Column(children: [
                  SafeArea(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                          ' ${BlocProvider.of<DoctorController>(context).alllbone.length} Items',
